...
const classesPage = ({classesArray, equipmentArray, instructors, shifts, activities, studentsArray, addClass, updateClass, deleteClass, inscriptionsArray, addInscription, updateInscription, deleteInscription}) => {
